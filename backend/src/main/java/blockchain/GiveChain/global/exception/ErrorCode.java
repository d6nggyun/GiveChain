package blockchain.GiveChain.global.exception;
...
public enum ErrorCode {
    ...
    // Jwt
    JWT_NOT_VALID(HttpStatus.UNAUTHORIZED, 401, "유효하지 않은 Jwt"),
    JWT_ACCESS_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, 419, "만료된 엑세스 토큰입니다."),
    JWT_REFRESH_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, 420, "만료된 리프레시 토큰입니다."),
    ...
    JWT_NOT_FOUND(HttpStatus.NOT_FOUND, 404, "리프레시 토큰 조회 실패"),
