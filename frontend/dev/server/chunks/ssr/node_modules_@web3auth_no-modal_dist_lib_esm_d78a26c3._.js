...
async function getAccounts(signClient) {
    ...
    const accounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccountsFromNamespaces"])(session.namespaces);
    if (accounts && accounts.length) {
        return [
            ...new Set(accounts.map((add)=>{
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseAccountId"])(add).address;
            }))
        ];
    }
...
class WalletConnectV2Provider extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$base$2d$provider$2f$baseProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BaseProvider"] {
    ...
    checkIfAccountAllowed(address) {
        ...
        const allAccounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccountsFromNamespaces"])(sessionData.namespaces);
        let accountAllowed = false;
        for (const account of allAccounts){
            var _parsedAccount$addres;
            const parsedAccount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseAccountId"])(account);
...
class WalletConnectV2Connector extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$connector$2f$baseConnector$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BaseConnector"] {
    ...
    async init(options) {
        ...
        this.connector = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].init(connectorSettings === null || connectorSettings === void 0 ? void 0 : connectorSettings.walletConnectInitOptions);
    ...
    async getUserInfo() {
        if (!this.connected) throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$errors$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletLoginError"].notConnectedError("Not connected with wallet, Please login/connect first");
        return {};
    }
    ...
    cleanupPendingPairings() {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidArray"])(inactivePairings)) return;
        inactivePairings.forEach((pairing)=>{
            if (this.connector) {
                this.connector.pairing.delete(pairing.topic, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSdkError"])("USER_DISCONNECTED"));
            }
        });
    }
